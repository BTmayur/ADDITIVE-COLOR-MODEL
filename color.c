...
void screen()
{
	...
	drawstring(120.0, 460.0, 0.0, "COMPUTER GRAPHICS LAB. Mini Project");

	drawstring(120.0, 435.0, 0.0, "on ''ADDITIVE COLOR MODEL''");

	glColor3f(1.0, 0.0, 0.0);
	drawstring(120, 375, 0.0, "By: ANIMATORS");
	drawstring(50, 350, 0.0, "Name:  MAYUR  USN: 1**20CS0**");
	drawstring(50, 325, 0.0, "Name: ARYAN   USN: 1**20CS0**");

	glColor3f(1.0, 1.0, 1.0);
	drawstring(50, 250, 0.0, "Department of Computer Science And");
	drawstring(50, 225, 0.0, "Engineering Academic Year: 2022-2023");

	glColor3f(rand() % 2, rand() % 2, 0.0);
	drawstring(250, 150, 0.0, "Press 'e' to start");
